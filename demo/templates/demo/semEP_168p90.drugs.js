...
$(function(){
  ...
  var graphP = $.ajax({
   // url: 'https://cdn.rawgit.com/maxkfranz/3d4d3c8eb808bd95bae7/raw', // wine-and-cheese.json
        url: './semEP_168p90.drugs.json',
    //  url: 'file://tib.tibub.de/DFS0/Home/PalmaG/Documents/workspace/visualization/wine_and_cheese/wineandcheeseTest/data.json',
    type: 'GET',
    dataType: 'json'
  });
 ...
 //     url: 'file://tib.tibub.de/DFS0/Home/PalmaG/Documents/workspace/visualization/wine_and_cheese/wineandcheeseTest/style.cycss',
      type: 'GET',
    dataType: 'text'
  });
  ...
  var infoTemplate = Handlebars.compile([
    ...
    '{{#if Country}}<p class="ac-country"><i class="fa fa-map-marker"></i> {{Country}}</p>{{/if}}',
      //   '<p class="ac-more"><i class="fa fa-external-link"></i> <a target="_blank" href="https://duckduckgo.com/?q={{name}}">More information</a></p>'
         '<p class="ac-more"><i class="fa fa-external-link"></i> <a target="_blank" href="https://www.google.com/search?q={{name}}">More information</a></p>'
  ].join(''));
  ...
  function initCy( then ){
    ...
    elements.nodes.forEach(function(n){
      ...
      if( data.NodeTypeFormatted === 'RedWine' ){
        data.NodeTypeFormatted = 'Drug';
      } else if( data.NodeTypeFormatted === 'WhiteWine' ){
        data.NodeTypeFormatted = 'Target';
      }
